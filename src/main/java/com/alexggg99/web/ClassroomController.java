...
public class ClassroomController {
    ...
    public Classroom updateContact(@PathVariable long classroomId ,@RequestBody Classroom classroom){
    ...
    public ResponseEntity<Void> deleteContact(@PathVariable long classroomId){
